...
> 具体的定义以及参数的解释[在API文档][1]或者源码【[帮您找好][2]】中`java.lang.annotation`包都可以很明确的了解。包括**内置注解**都可以直接看jdk中的具体实现。
...
一般情况下是用不到自己去实现一个注解的，只有开发框架什么的大牛们才会用到（为了给我这菜鸟用...），但是还是有必要简单了解一些。
  ...
  [1]: http://tool.oschina.net/apidocs/apidoc?api=jdk-zh
  [2]: http://grepcode.com/file/repository.grepcode.com/java/root/jdk/openjdk/8u40-b25/java/lang/annotation/Target.java?av=f
